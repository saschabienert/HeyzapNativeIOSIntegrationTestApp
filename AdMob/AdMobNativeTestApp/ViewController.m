...
{
    NSLog(@"[GADBannerViewDelegate] ad request successfully received an ad");
}
...
{
    NSLog(@"[GADBannerViewDelegate] ad request failed");
}
...
{
    NSLog(@"[GADBannerViewDelegate] full screen view will be presented in response to the user clicking on an ad");
}

/// Tells the delegate that the full screen view will be dismissed.
- (void)adViewWillDismissScreen:(GADBannerView *)bannerView
{
    NSLog(@"[GADBannerViewDelegate] the full screen view will be dismissed");
}
...
{
    NSLog(@"[GADBannerViewDelegate] the full screen view has been dismissed");
}
...
{
    NSLog(@"[GADBannerViewDelegate] the user click will open another app");
}
